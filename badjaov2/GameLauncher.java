...
/**
 * Main game launcher with level selection and game loop.
 */
public class GameLauncher extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Push Knight Peril - Level-Based Edition");
        primaryStage.show();
    }
    ...
    private void showLevelSelect() {
        ...
        levelSelectView.setOnBack(() -> {
            // Could go to main menu here
            System.out.println("Back pressed - would go to main menu");
        });
    ...
    private void startGame(int levelNumber) {
        System.out.println("[GAME] Starting Level " + levelNumber);
    ...
    private void handleGameOver(boolean victory) {
        ...
        String message = victory ? 
            "Congratulations! You completed Level " + logic.getSpawnSystem().getLevelNumber() + "!\n\n" +
            "Wave: " + logic.getSpawnSystem().getCurrentWave() + "/" + logic.getSpawnSystem().getTotalWaves() + "\n" +
            "Would you like to play again?" :
            "You were defeated on Wave " + logic.getSpawnSystem().getCurrentWave() + "\n\n" +
        ...
        alert.showAndWait().ifPresent(response -> {
            if (response == playAgain) {
                startGame(logic.getSpawnSystem().getLevelNumber());
