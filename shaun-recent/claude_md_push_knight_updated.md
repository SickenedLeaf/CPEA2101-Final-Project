...
- **Book System**: Spawns upgrade opportunity books after completing waves

### Trap System
- **Trap Class**: Bear traps that activate when stepped on by enemies or player
- **Trap Mechanics**: Traps deal damage and become deactivated, rearming after a delay
- **Trap Spawning**: Traps can be spawned during gameplay to aid in combat

### Upgrade System
- **UpgradeManager**: Handles player progression with upgrade levels
- **Upgrade Types**: Health, push range, push cooldown improvements, and push strength
...
- **Area Push Upgrade**: Special upgrade that enables wave push mechanic in cone pattern
- **Upgrade Selection**: Players can select from randomly generated upgrades between waves

### Advanced Push Mechanics
- **Basic Push**: Push adjacent enemies in direction of movement
- **Telekinetic Push**: With range upgrades, push enemies from a distance
- **Wave Push**: With area upgrade, push enemies in a cone pattern in front of player
- **Chain Push**: Push one enemy into another, causing a chain reaction
- **Push Strength**: Upgrade that increases distance enemies are pushed
...
### Audio System
- **AudioManager**: Complete audio system with per-enemy sound effects and background music
- **Sound Categories**: Menu sounds, battle sounds, UI sounds, mob sounds, and player sounds
- **Background Music**: Dynamic music that changes between menu and battle states
- **Per-Enemy Sounds**: Unique attack and death sounds for each enemy type
- **Player Sounds**: Push, damage, and death sound effects
...
#### Advanced Mechanics
- Push mechanics with range and strength upgrades
- Wave push ability that affects multiple enemies in a cone pattern
- Book collection system for upgrade opportunities between waves
- Trap system that can damage both enemies and player
...
- **Implementing upgrades**: Add new upgrade types to UpgradeManager and integrate with GameLogic
- **Adding sound effects**: Register new sounds in AudioManager and map to appropriate game events
- **Creating traps**: Extend Trap system with new trap types and mechanics
- **Special mechanics**: Implement new push mechanics and player special abilities
...
- The game features advanced mechanics like upgrade selection between waves, trap systems, and special push abilities
